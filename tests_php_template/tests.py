...
class TestTemplates(TestCase):
    def test_json(self):
        ...
        result = render(template=absolute_path_of_file_in_directory('json/template.php'), payload=test_data)
        # f = open(absolute_path_of_file_in_directory('json/expected_result.html'), 'w')
        # f.write(result)
        # f.close()
        expected_result = content_of_file_in_directory('json/expected_result.html')
